    ...
    describe 'Methods' do
        describe '#create' do
            it 'should login user' do
                ...
                current_user = User.create(email: 'shankar@gmail.com', password: 'shankar123',password_confirmation:'shankar123')
        ...
        describe '#destroy' do
            it 'should logout the user' do
                delete :destroy
                expect(session[:user_id][:authentication_token]).to eq(current_user.current_user)
            end
        end
